...
- element can be string (HTML element) or function (React element)
- Babel selects string/function based on case
- can set PropTypes at ComponentName.propTypes
- Babel will automatically remove PropTypes in production (dev only feature)
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=hannah.greenwell%40gmail.com).
