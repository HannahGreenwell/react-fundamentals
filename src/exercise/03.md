...
- include Babel as a script and compile on the fly
- script `type="text/babel"`
- write JSX in HTML file
- view Babel compiled version in `<head>`
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=hannah.greenwell%40gmail.com).
